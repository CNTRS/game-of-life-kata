...
describe("In the game of life", () => {
	it.skip("any live cell with fewer than two live neighbours dies, as if by underpopulation", () => {
	...
	it.skip("any live cell with two or three live neighbours lives on to the next generation.", () => {
	...
	it.skip("any live cell with more than three live neighbours dies, as if by overpopulation", () => {
	...
	it.skip("any dead cell with exactly three live neighbours becomes a live cell, as if by reproduction", () => {
		expect(Cell.create(CellStatus.Dead).regenerate(3).isAlive()).toBeTruthy();
	});
	it.skip("cells with undefined initial state are not allowed", () => {
